...
const Cart = () => {
  ...
  return (
    <div  className="bg-half-transparent w-full fixed nav-item top-0 right-0 duration-5000 ease-in-out transition-all ">
      <div className="float-right h-screen  duration-2000 ease-in-out dark:text-gray-200 transition-all dark:bg-[#484B52] bg-white md:w-400 p-8 pb-10 overflow-auto">
