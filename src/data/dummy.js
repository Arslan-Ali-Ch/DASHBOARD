...
export const dataImage=[avatar,avatar2,avatar3,avatar4,product1,
...
export const ordersData = [
  {
    ...
    Status: 'pending',
    StatusBg: '#FB9678',
    Image:  (params)=>`<img style="height:14px, width:14px" src=${params.data.avatar} />`
  },
  {
    OrderID: 345653,
